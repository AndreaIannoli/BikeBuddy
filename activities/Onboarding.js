    ...
    return(
        <ImageBackground source={require("../res/img/onboarding_bg.webp")} resizeMode="cover" style={styles.onboardingBG}>
            <View style={styles.container}>
                {selectedIndex !== 0 ?
                    <Image source={require("../res/img/bikebuddy_logo_wotext.webp")} resizeMode="contain" style={styles.logo}/>
                    :
                    null
                }
                {selectedIndex === 0 ?
                    <View style={styles.infoContainer}>
                        <Image source={require("../res/img/bikebuddy_logo_wtext.webp")} resizeMode="contain" style={styles.onboarding1}/>
                ...
                {selectedIndex === 1 ?
                    <View style={styles.infoContainer}>
                        <Image source={require("../res/img/onboarding_1.webp")} resizeMode="contain" style={styles.onboarding1}/>
                        <View style={styles.textContainer}>
                ...
                {selectedIndex === 2 ?
                    <View style={styles.infoContainer}>
                        <Image source={require("../res/img/onboarding_2.webp")} resizeMode="contain" style={styles.onboarding1}/>
                        <View style={styles.textContainer}>
